...
% --- Entradas ---
\node[label_txt] (a) at (0,2) {$A_i$};
\node[label_txt] (b) at (0,0) {$B_i$};
...
\node[label_txt] (psi) at (6,-1.5) {$\psi^{-k}$};
\draw[->] (psi) -- (times);

% --- Saídas ---
\node[label_txt, right=4.2cm of plus]  (out_top) {$A_i + B_i$};
\node[label_txt, right=1.2cm of times] (out_bot) {$(A_i - B_i)\,\psi^{-k}$};
